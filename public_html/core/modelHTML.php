...
static function barChart($datos=array(),$label,$contenedor)
	{
		...
		$graphic.= "datasets: [{label:'".$label."',fillColor: 'rgba(30,144,255,1)',";
		$graphic.= "strokeColor: 'rgba(30,144,255,1)',";
		$graphic.= "pointColor: 'rgba(30,144,255,1)',";
		$graphic.= "pointStrokeColor: '#c1c7d1',";
		$graphic.= "pointHighlightFill: '#fff',";
		$graphic.= "pointHighlightStroke: 'rgba(30,144,255,1)',";
		$graphic.= "data:[".$data."]";
		$graphic.= "}]};";
	...
	static function lineChart($datos=array(),$label,$contenedor)
	{
		...
		$graphic.= "showScale: true,";
		$graphic.= "scaleShowGridLines: false,";
		$graphic.= "scaleGridLineColor: 'rgba(0,0,0,.05)',";
		$graphic.= "scaleGridLineWidth: 1,";
		$graphic.= "scaleShowHorizontalLines: true,";
		$graphic.= "scaleShowVerticalLines: true,";
		$graphic.= "bezierCurve: true,";
		$graphic.= "bezierCurveTension: 0.3,";
		$graphic.= "pointDot: false,";
		$graphic.= "pointDotRadius: 4,";
		$graphic.= "pointHitDetectionRadius: 20,";
		$graphic.= "datasetStroke: true,";
		$graphic.= "datasetStrokeWidth: 2,";
		$graphic.= "datasetFill: true,";
		$graphic.= "legendTemplate: '<ul class=\"<%=name.toLowerCase()%>-legend\"><% for (var i=0; i<datasets.length; i++){%><li><span style=\"background-color:<%=datasets[i].fillColor%>\"></span><%if(datasets[i].label){%><%=datasets[i].label%><%}%></li><%}%></ul>',";
		$graphic.= "responsive: true,";
		$graphic.= "maintainAspectRatio: true";
		$graphic.= "};";
		$graphic.= "lineChartOptions.datasetFill = false;";
        $graphic.= "lineChart.Line(lineData, lineChartOptions);";
		$graphic.= "});";
		return $graphic;
	}
