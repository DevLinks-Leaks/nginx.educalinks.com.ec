...
?>
<div>
  <iframe style="width:100%;height: 400px;" src="../admin/libretas/<?=$_SESSION['directorio']?>/<?=$_SESSION['peri_codi']?>/lib_one.php?peri_dist_codi=<?=$peri_dist_codi?>&curs_para_codi=<?=$curs_para_codi?>&alum_codi=<?=$alum_codi?>"></iframe>
 </div>
 <?
