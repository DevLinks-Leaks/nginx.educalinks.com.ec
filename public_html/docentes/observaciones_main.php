	...
	<body class="general admin">
		...
		<div class="pageContainer"> 
          ...
          <!-- InstanceBeginEditable name="Titulo Top" -->
              ...
              ?>
          	<div class="title"><h3><span class="icon-folder-open icon"></span>Hoja de Vida Estudiantil</h3></div>
          <div class="options">
              <ul>
                  <li>
                  ...
                  <li>
                      <a class="button_text" href="../admin/reportes_generales/hoja_vida_estudiante.php?alum_curs_para_codi=<?= $alum_curs_para_codi; ?>" target="_blank">
