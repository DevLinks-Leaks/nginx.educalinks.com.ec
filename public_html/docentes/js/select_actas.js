...
function ValidarOpciones(parcialquim)
{
	...
	{
		divOpciones('acta_001', true,  true, "&nbsp;");
		divOpciones('acta_002', false, false, "&nbsp;");
		divOpciones('acta_003', true,  true, "&nbsp;");
		divOpciones('acta_004', true,  true, "&nbsp;");
	}
	else if (parcialquim.substring(0, 9)=='QUIMESTRE')
	{
		divOpciones('acta_001', true,  true, " quimestrales");
		divOpciones('acta_002', false, false, " quimestrales");
		divOpciones('acta_003', true,  true, " quimestrales");
		divOpciones('acta_004', true,  true, " quimestrales");
	}
	else if (parcialquim.substring(0, 6)=='EXAMEN')
	{
		divOpciones('acta_001', false, false, " examenes");
		divOpciones('acta_002', true,  true, " examenes");
		divOpciones('acta_003', true,  true, " examenes");
		divOpciones('acta_004', true,  true, " examenes");
	}
	else if (parcialquim.substring(0, 7)=='PARCIAL')
	{
		divOpciones('acta_001', false, false, " parciales");
		divOpciones('acta_002', true,  true, " parciales");
		divOpciones('acta_003', true,  true, " parciales");
		divOpciones('acta_004', true,  true, " parciales");
	}
}
