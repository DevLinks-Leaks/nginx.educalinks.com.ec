...
<table class="table_striped_rollover">
 ...
 ?>
  <tr>
    ...
    <td height="29">
    	<a 
        	onClick="window.location='tutor_deta_alum.php?curs_para_codi=<?= $row_curs_prof_tuto_view["curs_para_codi"]; ?>&peri_dist_codi='+document.getElementById('peri_dist_codi_<?= $cc ?>').value" 
