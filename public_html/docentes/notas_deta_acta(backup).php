    ...
    <div  class="lista" >
    	<div class="header_institution">
    		<div class="institution">
    			<div class="image">
                    <img 
                        src="../imagenes/reportes/<?= $_SESSION['directorio']; ?>/logo_libreta.png" 
                        width="90" 
                        height="107">
    			</div>
    			<div class="name">
    			<h4>
                	<strong> 
                    UNIDAD EDUCATIVA <?= para_sist(2); ?> 
                    </strong>
				</h4>
    			<h4>
					<?= $cab_row['nivel_1']."  ".$cab_row['nivel_2'].' - '.$row_curs_peri_info['mate_deta'];?>
                </h4>
    			<h5>
			...
			<td align="right">
				...
				?>
                    ...
                    <?php
                        ...
                        $prom[$CC_COLUM_index] =  $prom[$CC_COLUM_index] + 
...
<table class="table_striped" style="margin-top: 10%;">
	<tr>
    	<td width="50%" align="center">
            ______________________________________
            <br />
            <? 
                echo $prof_row["prof_nomb"]." ".
                     $prof_row["prof_apel"]; 
            ?>
            <br />
            Profesor
