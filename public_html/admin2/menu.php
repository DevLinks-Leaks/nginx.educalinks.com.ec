			...
			<ul class="sidebar-menu">
				...
				<li class="<? if (substr($Menu,0,1)==2) echo 'active'; ?> treeview"><!-- AQUI SERIA EL OPEN --><!--  -->
					...
					<ul class="treeview-menu">
						...
						<?php if(permiso_activo(62))?> <li <? if($Menu==206) echo 'class="active"'; ?>><a href="cursos_notas_permisos_main.php"><span class='fa fa-circle-o'></span> Cursos</a></li>
						<?php if(permiso_activo(11))?> <li <? if($Menu==202) echo 'class="active"'; ?>><a href="cursos_cursos_main.php"><span class='fa fa-circle-o'></span> Notas Permisos</a></li>
