					...
					while($CC_COLUM_index <= $CC_COLUM)
					{
						...
						{	if ($row_curs_para_mate_info['nota_refe_cab_tipo']=='C')
							...
							{	
								...
								echo "<select id='nota_". $cc . "_" . $CC_COLUM_index. "'>";
						...
						{	//muestra promedio
							...
							{	?><input 
									type="number" 
									class="cls_validar"  
									value="<?php echo $row_curs_para_nota_peri_dist_view[$CC_COLUM_index + 10]; ?>"
									id="promedio_<?= $cc;?>"
									style="width:70px"
									readonly='readonly'/>
								<?php
	...
	<table width="400" border="0" cellpadding="0" cellspacing="0"   style="float:right;">
		<tr>
			<td height="120" align="left" valign="middle">
				<button class="btn btn-primary" onclick="curs_para_nota_peri_dist_save();">&nbsp;&nbsp;&nbsp;&nbsp;Grabar&nbsp;&nbsp;&nbsp;</button></td>
			<td height="80" align="left" valign="middle">
				<button class="btn btn-primary" onclick="document.location='cursos_paralelo_notas_mate_main.php?peri_codi=<?= $row_curs_para_mate_info['peri_codi'] ?>&curs_para_codi=<?= $row_curs_para_mate_info['curs_para_codi'] ?>'">Cancelar</button></td>
		</tr>
	</table>
</div>
