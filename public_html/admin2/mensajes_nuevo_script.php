...
?>
 ...
 <script type="text/javascript" src="../framework/funciones.js"> </script>
        ...
        <div class="col-md-12"  id="usua_mens" style="height:100px; margin-bottom:10px; overflow:scroll; overflow-x: hidden;"    >
      
        </div>
          <div class="col-md-12"  id="usua_mens" style="border:thin; height:40px;margin-bottom:5px;float:left;"    >
