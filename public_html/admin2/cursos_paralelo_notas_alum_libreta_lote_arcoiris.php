...
<div class="libreta" style="clear:both;">
            	...
            	if ($row_alum_nota_peri_dist_view[$CC_COLUM_index + 12]>0 and $row_alum_nota_peri_dist_view[$CC_COLUM_index + 12]<>null)
            	{
            		switch ($row_alum_nota_peri_dist_view['mate_tipo'])
            		{
            			case "C":
            				...
            				if(($row_alum_nota_peri_dist_view[$CC_COLUM_index + 12]>0) and ($row_alum_nota_peri_dist_view[$CC_COLUM_index + 12]<7))
            				{
            					echo "*";
            				}
            			break;
	...
	?>
    <div style="border: 1px solid #999; margin-top: 5px; margin-buttom:0px">
 ...
 <div class="CSSTableGenerator half_end" style="margin-top: 0px">
	...
	?>
	<div style="border: 1px solid #999; margin-top: 5px; height: 60px ;padding: 2px">
