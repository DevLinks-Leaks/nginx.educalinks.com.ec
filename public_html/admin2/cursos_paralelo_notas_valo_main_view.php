        ...
        <tr onclick="">
            ...
            <td>               		
                <div class="menu_options">  
                  <ul>
                    <li>
                        <a class="option" onclick="window.location='cursos_paralelo_notas_comp_main.php?peri_dist_codi=<?= $peri_dist_codi; ?>&valo_codi=<?= $row_cali_comp_valo_view["valo_codi"]; ?>&curs_para_codi=<?= $_GET['curs_para_codi'];?>'"> 
