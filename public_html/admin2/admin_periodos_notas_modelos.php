			...
			<div class="content-wrapper">
				<section class="content-header">
					<?php
				  	...
				  	?>
					<h1>Periodos Modelos de Notas <?= $row_peri_info['peri_deta'];	?> </h1>
					<ol class="breadcrumb">
						<li><a href="#"><i class="fa fa-circle-o"></i></a></li>
						<li class="active">Periodos Modelos de Notas <?= $row_peri_info['peri_deta'];	?> </li>
					</ol>
				</section>
	...
	<div class="modal-content">
	  ...
	  <div class="modal-body">
			 <table width="100%" border="0" cellspacing="0" cellpadding="0">                                      
				<tr>
					<td height="50px"> </td>
					<td><input id="" type="text" class='form-control input-sm' value=""  ><br><br>
						<br>
					</td>
				</tr>
			</table>
