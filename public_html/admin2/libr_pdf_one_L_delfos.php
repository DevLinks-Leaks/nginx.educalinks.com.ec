...
$tabla_mision.= '</tr>';
$tabla_mision.= '<tr>';
$tabla_mision.= '<td class="cuerpo_notas">Formar en base a valores éticos y morales en cada una de las áreas del conocimiento. Integrando a niños, jóvenes con habilidades múltiples y necesidades educativas para alcanzar un verdadero desarrollo; comprometidos con la mejora continua, buscando la excelencia institucional.</td>';
$tabla_mision.= '</tr>';
$tabla_mision.= '</table>';
/*Visión*/
