<?
	...
	<ol>
		...
		<li>
		Cumplir con las obligaciones voluntariamente contraídas, en especial: la puntualidad en el ingreso a clases de mí representado (a), la observancia de su aseo y correcto uso del uniforme; el pago a tiempo de las expensas educativas (matrícula, pensiones por servicios educativos). 
		</li>
		<li>
	...
	<td class="centrar">
	_______________________________________<br/>
	Firma del (la) representante financiero<br/>
	{$row_representante_fina["nombres"]}<br/>
	{$row_representante_fina["correo"]}<br/>
	Cédula No.
	</td>
	</tr>
	</table>
...
$pdf->Image($img_alum, 170, 15, 25, 30, 'JPG', '', 'C', false, 300, '', false, false, 0, false, false, false);
