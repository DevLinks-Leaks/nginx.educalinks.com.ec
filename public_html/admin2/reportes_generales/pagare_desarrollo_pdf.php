<?
	...
	{	/*Valores en letras*/
		...
		$total_pension = number_format($row_valores['precio_pension']*10,2,'.',',');
		$total_pension_letras = strtoupper(AifLibNumber::toWord($row_valores['precio_pension']*10));
		$pension = number_format($row_valores["precio_pension"],2,'.',',');
		$pension_let = strtoupper(AifLibNumber::toWord($row_valores['precio_pension']));
	}
