<?
	...
	<table >
		<tr>
			...
			<!--<td class="derecha" style="font-size: 8px" width="25%">Código: R13-08 Versión: 4 <br/>Feb/2016</td>-->
		</tr>
	</table>
	...
	<p class="letras_pequenas">
	<strong>CLÁUSULA OCTAVA: DEL SEGURO DE ACCIDENTES PERSONALES:</strong>
	De conformidad a la normativa expedida por el Ministerio de Educación, se pone a consideración de los padres de familia un seguro de accidentes personales, en aras de cubrir posibles lesiones que pueda tener el estudiante dentro de la institución educativa. En caso de que el padre de familia no acepte dicho seguro, deslinda de responsabilidad al colegio, en relación al posible accidente.
	</p>
	<p class="letras_pequenas">
	<strong>CLÁUSULA NOVENA: DURACIÓN:</strong> 
	...
	<p class="letras_pequenas">
	<strong>CLÁUSULA DÉCIMA: DE LA TERMINACIÓN DEL CONTRATO:</strong>
	...
	<p class="letras_pequenas">
	<strong>CLÁUSULA DÉCIMA PRIMERA: TRÁMITE Y COMPETENCIA: CLASULA COMPROMISORIA:</strong> 
	En caso de que existan divergencias entre las partes en relación a lo que se ha estipulado por las mismas en el presente convenio, estas deciden acudir a un proceso de mediación ante un mediador de la Centro de Arbitraje y Mediación de la Universidad de Especialidades Espíritu Santo CAM UESS. En caso de que los conflictos no fueren resueltos mediante el procedimiento de mediación, las partes convienen en someter sus controversias y divergencias a la resolución de un Tribunal de Arbitraje en Derecho en el mismo Centro de Arbitraje y Mediación de la Universidad de Especialidades Espíritu Santo CAM UESS, que se sujetará en lo dispuesto en la Ley de Arbitraje y Mediación, en el Reglamento del Centro de Arbitraje y Mediación de la Universidad Particular de Especialidades Espíritu Santo y a las siguientes normas:
	<ol type="a">
	<li>
	El Tribunal estará integrado por un árbitro designado por el (la) Directora del Centro, según sus normas, si la cuantía no es mayor o hasta diez mil dólares de Estados Unidos de América.  Si la cuantía es mayor de los diez mil dólares, el tribunal estará compuesto tres árbitros, designados conforme a la Ley de Arbitraje y Mediación; 
	</li>
	<li>
	...
	<li>
	Las partes se comprometen a aceptar a aceptar lo resuelto en la etapa de mediación, así como las medidas cautelares que se disponga dentro del procesamiento. 
	</li>
	<li>
	...
	<li>
	Renunciando fuero, jurisdicción, domicilio y vecindad, el lugar del arbitraje serán las instalaciones del Centro de Arbitraje y Mediación de la Universidad de Especialidades Espíritu Santo CAM UESS; 
	</li>
	<li>
	El idioma del arbitraje será el Castellano; y, 
	</li>
	<li>
	Los costos de la mediación serán asumidos por LA PARTE que origina el procedimiento o la que determine el Tribunal.
	</li>
	</ol>
	</p>
	<p class="letras_pequenas">
	...
	El (la) Representante Legal<br/>
	{$representante["nombres"]}<br/>
	{$representante["correo"]}
	</td>
	<td class="centrar">
	f)___________________________________________<br/>
	El (la) Representante Financiero<br/>
	{$representante_fina["nombres"]}<br/>
	{$representante_fina["correo"]}
	</td>
	</tr>
	<tr>
	<td colspan="2">
...
$pdf->Line(10,23,200,23,array('width'=>0.4,'color'=>array(0,0,0)));
$pdf->Ln(5);
