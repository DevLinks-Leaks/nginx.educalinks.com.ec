...
$stmt = sqlsrv_query($conn, $sql, $params);
$row_representante_f = sqlsrv_fetch_array($stmt);
...
$html=<<<EOD
	...
	<br>
	<h1>INFORMACIÓN PERSONAL PARA PREINSCRIPCIÓN</h1>
	<p class="letras_normales">CURSO: {$row['curs_sig']} DE {$row['nive_sig']}</p>
	...
	<table width="100%" border="1">
		...
		<tr>
			...
			<td width="50%">{$row_alum["alum_domi"]}</td>
			<td width="15%">Ciudad Dom.:</td>
		...
		<tr>
			...
			<td width="15%">Ciudad Nac.:</td>
			<td width="15%">{$row_alum["alum_ciud_naci"]}</td>
			<td width="15%">País:</td>
	...
	<h3>DATOS DEL(LA) REPRESENTANTE LEGAL</h3>
	<table border="1">
		<tr>
			<td width="10%">Apellidos:</td>
	...
	<h3>DATOS DEL(LA) REPRESENTANTE FINANCIERO</h3>
	<table border="1">
		<tr>
			<td width="10%">Apellidos:</td>
			<td width="40%">{$row_representante_f["repr_apel"]}</td>
			<td width="10%">Nombres:</td>
			<td width="40%">{$row_representante_f["repr_nomb"]}</td>
		</tr>
		<tr>
			<td width="20%">Dirección domiciliaria:</td>
			<td width="80%">{$row_representante_f["domicilio"]}</td>
		</tr>
		<tr>
			<td width="10%">Teléfonos:</td>
			<td width="15%">Casa</td>
			<td width="15%">{$row_representante_f["telefono"]}</td>
			<td width="15%">Celular</td>
			<td width="15%">{$row_representante_f["repr_celular"]}</td>
			<td width="15%">Correo</td>
			<td width="15%">{$row_representante_f["correo"]}</td>
		</tr>
		<tr>
			<td width="20%">Número de cédula:</td>
			<td width="20%">{$row_representante_f["cedula"]}</td>
			<td width="15%">Estado civil:</td>
			<td width="15%">{$row_representante_f["estado_civil"]}</td>
			<td width="15%">Nacionalidad:</td>
			<td width="15%">{$row_representante_f["nacionalidad"]}</td>
		</tr>
	</table>
	<table>
		<tr>
