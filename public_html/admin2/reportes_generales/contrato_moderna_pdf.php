<?
	...
	<br/>
	<b>4.3. SERVICIO INCLUSIVO:</b> El servicio educativo de la Institución es inclusivo para niños y jóvenes con dificultad en el aprendizaje que se encuentren consideradas como leves y dentro del primer grado de dificultad, siempre que no sean combinadas. No es un centro de educación especial, por lo que, si el estudiante necesita más apoyo para mejorar o superar su conducta o aprendizaje, se podrá autorizar que ingresen y laboren, profesionales o personas especializadas en esas áreas para brindarles atención complementaria con servicio fijo o itinerante, en los casos más serios o complejos, para efectuar acompañamiento y apoyo personalizado al estudiante, a costa y bajo responsabilidad del representante y la Institución no adquiere ninguna obligación o compromiso con los mismos.
	<br/>
	...
	<td class="centrar">
	f)_______________________________________________<br/>
	CPA. LUZ MARIA PESANTES FAJARDO<br/>
	GERENTE DE INEMOQUIL
	</td>
	</tr>
	</table> 
	</p>        
