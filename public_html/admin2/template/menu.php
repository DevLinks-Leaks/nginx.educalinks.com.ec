	<aside class="main-sidebar">
        ...
        <section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="<? if ($Menu==901) echo 'active'; ?>"><a href="../../admin/profesores_main.php"><i class="fa fa-briefcase" title='Bandeja de profesores. Lista de profesores.'></i> <span>Profesores</span></a></li>
				<?php }?>
				...
				<li class="<? if (substr($Menu,0,1)==4) echo 'active'; ?> treeview"><!-- AQUI SERIA EL OPEN --><!--  -->
					...
					<ul class="treeview-menu">
						...
						<li class='<? if (substr($Menu,1,1)==1) echo 'active'; ?>  treeview'><a href="#"><i class="fa fa-lock"></i> <span>Permisos</span> <i class="fa fa-angle-left pull-right"></i></a>
							<ul class="treeview-menu">
								<?php if(permiso_activo(20))?> <li <? if($Menu==416) echo 'class="active"'; ?>><a href="admin_permisos.php"><span class='fa fa-users'></span> De usuario</a></li>
								...
								title='El usuario puede activar ciertas funcionalidades del sistema, determinando el tiempo por el cual el acceso a la misma es vigente para los usuarios'><span class='fa fa-clock-o'></span> Por tiempo</a></li>
								<?php if(permiso_activo(11))?> <li <? if($Menu==412) echo 'class="active"'; ?>><a href="cursos_notas_permisos_main.php" title='Permisos de ingresos de notas a docentes.'><span class='fa fa-list-alt'></span> De ingreso notas</a></li>
							</ul>	
						</li>
