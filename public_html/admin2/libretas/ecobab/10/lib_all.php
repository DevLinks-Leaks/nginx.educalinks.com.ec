...
<div class="libreta" style="clear:both;">
    <div class="header_institution">
        ...
        <div class="user_data">
            <div class="image" style="height: 55px; width:55px">
            	<img src="<?php echo $pp;?>" border="0" style="border-color:#F0F0F0; height: 55px; width:55px"/>
            </div>
        <div class="name">
      ...
      <table class="table_striped" width="50%">
        ...
        <tr>
          ...
          <?php 
		  	$perc = (int)$cabecera[ $CC_COLUM_index ];
			$mayor_aceptable = ( ( 7 * $perc ) / 100 ); //EDUCALINKS PENDIENTE
			if(($prom[$CC_COLUM_index]/$prom_cc[$CC_COLUM_index])<$mayor_aceptable)
			{
				echo " class='mala_nota'";
			}
		  ?>
    ...
    <div style="border: 1px solid #999; height: 80px; margin-top: 5px;">
    	<p style="padding: 5px 10px; margin: 0 0">
    		Visite 
            <span style="font-weight: bolder; font-style:italic;">www.ecoundobabahoyo.edu.ec</span> / 
            <span style="font-weight: bolder; font-style:italic;">ecobab.educalinks.com.ec</span>
		</p>
        <ul>
        	<li>
 ...
 <div class="CSSTableGenerator half_end" >
  ...
  <table class="table_striped">
        ...
        <tbody>
          ...
          <tr>
            <td><?= $row_nota_peri_cual_tipo_view['nota_peri_cual_deta']; ?></td>
            <td><?= truncar($row_nota_peri_cual_tipo_view['nota_peri_cual_ini']); ?> - <?= truncar($row_nota_peri_cual_tipo_view['nota_peri_cual_fin']); ?></td>
