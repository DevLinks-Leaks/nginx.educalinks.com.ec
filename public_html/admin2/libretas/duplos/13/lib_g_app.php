...
{	private $codigo;
	...
	{	$logo_cole = '../../../../imagenes/clientes/duplos/logo_inicial_long.png';
...
/*Foto del estudiante*/
$file_exi = '../../../../fotos/duplos/alumnos/'.$peri_codi.'/'.$alum_codi.'.jpg';
if (file_exists($file_exi))
{	$pp=$file_exi;
} 
else 
{	$pp='../../../../fotos/duplos/alumnos/0.jpg';
}
$pdf->setFoto($pp);
/*Consultas a la BD*/
/*Quimestre y Parcial*/
