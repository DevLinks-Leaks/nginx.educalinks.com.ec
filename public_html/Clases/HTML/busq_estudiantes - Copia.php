                        ...
                        <td>
                            <div class="row">
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                    <?php 
                                    $ruta = "../fotos/".$_SESSION['directorio']."/alumnos/".$_SESSION['peri_codi']."/".$estudiante['alum_codi'].".jpg";
                                    $ruta2 = "../fotos/".$_SESSION['directorio']."/alum_0.jpg";?>
                                    <?php 
                                    if (file_exists("../".$ruta)){ ?>
                                        <img src="<?=$ruta;?>" class="img-responsive img-thumbnail" width="60px" height="60px" />
                                    <?php 
                                    }else{ 
                                        ?>
                                        <img src="<?=$ruta2;?>" class="img-responsive img-thumbnail" width="60px" height="60px" />
                                    <?php 
                                    }?>
                                </div>
