...
class NotificacionesAlumnos extends DB_Abstract_mobile
{
	...
	public function getNotificacionesAlumnos($alumcodi,$tipousua)
	{
        $this->parametros = array($alumcodi,$tipousua);
