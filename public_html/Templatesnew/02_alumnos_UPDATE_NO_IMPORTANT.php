...
<section class="header container-fluid">
    <div class="row">
        ...
        <div class="userbar col-md-8 col-xs-9">
                ...
                <nav class="navbar navbar-default">
                  <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar_collapse_01" aria-expanded="false">
                        <span class="sr-only">Toggle navigation</span>
                        <span class="icon-bar"></span>
                        <span class="icon-bar"></span>
                        <span class="icon-bar"></span>
                      </button>
                      <a class="user visible-xs" href="#">
                    ...
                    <div class="collapse navbar-collapse hidden-xs" id="navbar_collapse_01">
...
<div class="collapse navbar-collapse visible-xs" id="navbar_collapse_01">
                            <ul class="nav navbar-nav "><!-- MENU MOVIL -->
                                            <? 
                                            /*Pregunto si está activada la opción para cambiar fotos*/
                                            if (para_sist(21))
                                            {
...
<div class="section_menu">
    ...
    <ul class="nav nav-pills nav-justified">
        <li <? if ($Menu==0) { echo 'class="active background_link_default"';} else { echo' class="link_menu"'; } ?> >
