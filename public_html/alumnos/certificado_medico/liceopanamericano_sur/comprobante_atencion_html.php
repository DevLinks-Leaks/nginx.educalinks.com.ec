    ...
    <div class="contenedor_impr">
        <table border="0" cell-padding="0" cellspaciong="0">
            <tr>
                ...
                <td  style="text-align: right"><h5>Comprobante de Atención</h5></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                <td>&nbsp;</td>
                <td style="text-align: right">REG.3.3.5.05</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td style="text-align: right">Cita médica</td>
            </tr>
            <tr>
                <td colspan="2"><hr/></td>
            </tr>
            ...
            <tr>
                <td colspan="2">Profesor: {prof_nomb}</td>
            </tr><tr>
                <td colspan="2">Materia: {mate_deta}</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
