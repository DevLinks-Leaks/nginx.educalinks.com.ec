...
$my_report = "C:/inetpub/wwwroot/IngeniumAcad/reportes/test.rpt"; // Ruta fisica al reporte en el servidor
$exp_pdf = "C:/inetpub/wwwroot/IngeniumAcad/reportes/test.pdf"; // ruta fisica donde se guardara el PDF resultado en el servidor
...
$creport->Database->Tables->Item(1)->ConnectionProperties["Password"] = "xxxxxx";
