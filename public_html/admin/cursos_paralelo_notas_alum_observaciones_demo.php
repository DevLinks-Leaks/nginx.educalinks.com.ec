      ...
      <div class="header_institution">
        <div class="institution">
          <div class="image" style="margin-right: 5px;">
            <img src="<?= $_SESSION['ruta_foto_logo_libreta']; ?>" style="width: 75px; height: 75px">
          </div>
          <div class="name">
                  <h4 style="margin: 2px 0;"><strong> <?= para_sist(3); ?> </strong></h4>
      ...
      <table class="table_striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td align="center"
            <?php 
				if(($row_alum_nota_peri_dist_view[$CC_COLUM_index + 11])<7)
				{
            ...
            >
            	<? if ($row_alum_nota_peri_dist_view['mate_tipo'] <> 'D' and $row_alum_nota_peri_dist_view['mate_tipo'] <> 'P' ) {?> 
             		<?=
					(number_format($row_alum_nota_peri_dist_view[$CC_COLUM_index + 11], 2, '.', '')==0)?'':number_format($row_alum_nota_peri_dist_view[$CC_COLUM_index + 11], 2, '.', '');
					 ?>                      
             	<? } ?>
             <? if ($row_alum_nota_peri_dist_view["mate_prom"] =='A'){ $prom_cc[$CC_COLUM_index] =  $prom_cc[$CC_COLUM_index] + 1; 
              $prom[$CC_COLUM_index] =  $prom[$CC_COLUM_index] + $row_alum_nota_peri_dist_view[$CC_COLUM_index + 11];
            }?>
          </td>
