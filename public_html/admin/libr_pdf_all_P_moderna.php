...
{	private $codigo;
	...
	{	$logo_cole = $_SESSION['ruta_foto_logo_index'];
		...
		$this->Image($this->foto, 187, 11, 16, 18, 'JPG', '', 'C', false, 300, '', false, false, 0, false, false, false);
		...
		$this->MultiCell(0, 4, mb_strtoupper(substr($this->nombre.' '.$this->apellido,0,45),'utf8').' / '.$this->codigo, 0, 'L', 0, 1, 55, '', true);
