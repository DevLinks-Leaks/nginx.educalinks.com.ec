<?
	...
	class MYPDF extends TCPDF 
	{
		public function Header() 
		{
			...
			$this->Image($logo_minis, 10, 15, 40, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
			
			$logo_distr = '../'.$_SESSION['ruta_foto_escudo_ecuador'];
			$this->Image($logo_distr, 97, 18, 15, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
		}
	...
	$encabezado_1 = '	<tr>
						<td colspan="2" class="titulo"><br/><br/>ARMADA DEL ECUADOR<br/>'.$antes_del_nombre.'<br/> '.$nombre_colegio.'</td>
					</tr>
					<tr>
						<td colspan="2" class="titulo"><br/>'.$ciudad.'</td>
					</tr>
					<tr>
						<td colspan="2" class="titulo"><br/>-o-</td>
					</tr>
					<tr>
						<td colspan="2" class="titulo"><br/><br/></td>
					</tr>';
	$encabezado_2 = '<tr>
						<td colspan="2" class="titulo"><br/><br/></td>
					</tr>
					<tr>
						<td colspan="2" class="titulo_cert"><br/><u>CERTIFICADO DE MATRÍCULA</u></td>
					</tr>';

	$texto='<p>Los suscritos, '.$rector.' y '.$secretario.', en calidad de Rector y Secretaria General respectivamente, certifican que el(a) estudiante:</p>';
	$linea_fecha='';
	$linea_fecha2=$fecha_hoy2;

	$rector_mayus =strtoupper($rector);
	$secretario_mayus=strtoupper($secretario);
	...
	while ($alumno=sqlsrv_fetch_array($stmt))
	{
		...
		$jornada = '<tr>
						<td colspan="2" class="jornada"><br/><u>JORNADA '.mb_strtoupper($alumno['jorn_deta']).'</u></td>
					</tr>';
		...
		<table width="100%" border="0">
			...
			<tr>
				<td align="center" class="firma"><br/>
					{$rector_mayus}<br/>
					<b>{$etiqueta_rector}</b>
				</td>
				<td align="center" class="firma"><br/>
