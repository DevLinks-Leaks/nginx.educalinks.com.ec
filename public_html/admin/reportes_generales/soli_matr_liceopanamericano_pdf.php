<?
	...
	ASPIRANTE A ESTUDIANTE DE {$antes_del_nombre} {$nombre_colegio}</h1>
	<p class="letras_normales">Nivel de Educación: {$row["nive_deta"]} </p>
	...
	<p class="letras_normales">{$etiqueta_rector}:</p>
	<p class="letras_normales">
	El (la) infrascrito (a) {$row["repr_nomb"]} {$row["repr_apel"]}, en mi calidad de representante del (la) menor {$row["alum_nomb"]} {$row["alum_apel"]}, considerando la visión, misión, objetivos  y principios de la {$antes_del_nombre} {$nombre_colegio} libre y voluntariamente solicito a usted, se sirva autorizar la respectiva matrícula para mi representado (a), que ha sido promovido (a) para  el {$row["curs_promovido"]} del nivel de {$row["nive_deta"]} para el período lectivo {$peri_deta}.
	</p>
	<p class="letras_normales">
	Como representante del (la) menor anteriormente referido (a), declaro conocer la normativa legal y reglamentaria que rige el sistema educativo en el Ecuador en general y, en particular, el sistema de estudios de la Unidad Educativa Particular Bilingüe Liceo Panamericano, su Proyecto Educativo Institucional - PEI y el Código de Convivencia, Reglamento Interno y demás Reglamentos específicos y regulaciones internas, que me han sido proporcionadas y se encuentran publicadas en la página web institucional; normatividad a la que me comprometo respetar y hacer que mi representado (a) la respete y la observe en su accionar dentro y fuera de la Institución.
	</p>
	<p class="letras_normales">
	...
	<ol>
		...
		<li>
		Controlar que utilice en forma correcta el uniforme, con sus implementos de estudio, tareas o trabajos, al igual que enviar el lunch recomendado para una correcta dieta alimenticia, por tanto este envío de refrigerio, debe ser realizado a inicio de la jornada académica y no durante o al término de la misma. De igual manera controlaré  que no lleve a la institución sustancias u objetos prohibidos o ajenos al quehacer educativo.
		</li>
		<li>
	...
	<p class="letras_normales">
	Espero que la matrícula solicitada sea concedida bajo los compromisos y obligaciones anteriormente descritos, los mismos que tendrán validez durante todo el tiempo que mi representado (a) estudie en el Liceo Panamericano, en cualquiera de sus niveles.
	</p>
	<p class="letras_normales">
	Muy atentamente.
	</p>
	...
	{$row_representante["nombres"]}<br/>
	{$row_representante["correo"]}<br/>
	Cédula No.
	</td>
	</tr>
	</table>
...
$html=<<<EOD
	...
	<p class="letras_normales"><h3>Relación de los padres:</h3> {$row_alum["alum_estado_civil_padres"]}</p>
	<p class="letras_normales"><h3>Representante(s): </h3> Ante la institución para citaciones, notificaciones, asuntos académicos, disciplinario y retiro de documentos: </p>
	<p class="letras_normales">Padre: (  ) Madre: (  ) Ambos: (  ) Terceros: (  )</p>
...
$pdf->Image($img_alum, 170, 9, 25, 30, 'JPG', '', 'C', false, 300, '', false, false, 0, false, false, false);
