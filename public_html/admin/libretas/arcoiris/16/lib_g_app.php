	...
	{	$recomendaciones.='<tr><td class="cuerpo_notas" width="25%">';
		...
		{	switch ($row_alum_nota_peri_dist_view_2['mate_tipo'])
			{	case "C":
				...
				break;
				case "D":
				$recomendaciones.= notas_prom_quali($peri_codi,'D',$row_alum_nota_peri_dist_view_2['PM']);
				break;
				case "P":
				$recomendaciones.= notas_prom_quali($peri_codi,'P',$row_alum_nota_peri_dist_view_2['PM']);
				break;
			}
		}	            
		$recomendaciones.='</td>';
