...
$tabla_inicial_esp.= '<td class="cabecera_notas centrar" colspan="2"><b>EQUIVALENCIAS DE INICIAL</b></td>';
$tabla_inicial_esp.= '</tr>';
$params = array(4);
...
$tabla_firmas.= '<td class="firmas centrar" width="33%">_______________________________<br/>'.para_sist(6).'<br/>'.para_sist(34).'</td>';
...
/*Foto del estudiante*/
$file_exi = '../../../../fotos/arcoiris/alumnos/'.$peri_codi.'/'.$alum_codi.'.jpg';
if (file_exists($file_exi))
{	$pp=$file_exi;
} 
else 
{	$pp='../../../../fotos/arcoiris/alumnos/0.jpg';
}
$pdf->setFoto($pp);
...
$logo_cole = '../../../../imagenes/clientes/arcoiris/logo_inicial_long.png';

$cabecera = '<table border="0" width="100%">
				<tr>
					<td class="centrar_vertical_img_logo" rowspan="5" width="10%"><img height="50px" width="50px" src="'.$logo_cole.'" /></td>
					<td class="cabecera" width="75%">BOLETÍN DE CALIFICACIONES</td>
					<td class="centrar_vertical_img_foto" rowspan="4" width="15%"><img height="45px" width="45px" src="'.$pp.'" /></td>
				</tr>
				<tr>
					<td class="cabecera" width="75%">'.mb_strtoupper($cab_row['nivel_1']."  ".$cab_row['nivel_2'],'utf8').'</td>
				</tr>
				<tr>
					<td class="cabecera" width="75%">'.mb_strtoupper($row_curs_info['curs_deta'].' '.$row_curs_info['nive_deta'].' "'.$row_curs_info['para_deta'].'"','utf8').'</td>
				</tr>
				<tr>
					<td class="cabecera" width="75%">'.mb_strtoupper($row_alum_info['alum_apel']." ".$row_alum_info['alum_nomb'],'utf8').'</td>
				</tr>
				<tr>
					<td></td>
