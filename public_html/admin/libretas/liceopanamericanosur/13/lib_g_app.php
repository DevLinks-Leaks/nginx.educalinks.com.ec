...
$db = "Educalinks_liceopanamericano_sur"; 
$uid = "sa";
$pwd = "$3cur!ty@@";
$charset = "UTF-8";
...
{	private $codigo;
	...
	{	$logo_cole = '../../../../imagenes/clientes/liceopanamericanosur/logo_inicial_long.png';
		...
		$this->MultiCell(0, 5, mb_strtoupper($this->curso,'utf8'), 0, 'L', 0, 1, '', '', true);
                ...
                $this->MultiCell(0, 0, mb_strtoupper(substr($this->apellido.' '.$this->nombre,0,35),'utf8'), 0, 'L', 0, 1, 230, 17, true);
...
<td width="50%"> {$tabla_contraseñas}</td>
</tr>
</table>
EOF;
