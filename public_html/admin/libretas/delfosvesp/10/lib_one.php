	...
	<div  class="libreta" >
		...
		<div class="CSSTableGenerator full" style="margin-bottom: 0px">
			<table class="table_striped">
				...
				<tbody>
					...
					?> 
					<tr>
						<td width="25%" style="border: solid 1px black" width="<?= $mate_size; ?>%">
		...
		?>
			...
			<div style="border: 1px solid #999;margin-top: 5px; padding: 2px; text-align: justify;">
				EQUIVALENCIAS CUALITATIVAS DE PROYECTOS:<br/>
				<?php
			...
			<div style="border: 0px solid #999; margin-top: 5px; padding: 2px;text-align: left;">
				...
				unset($array1);
				$array1[]=array();
				//$array1[0]="<td align='left' width='30%' valign='top' style='font-weight: bold;'>Comportamiento:</td>";
