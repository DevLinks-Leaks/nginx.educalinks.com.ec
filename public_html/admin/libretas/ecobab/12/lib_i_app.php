...
/*Foto del estudiante*/
$file_exi = '../../../../fotos/ecobab/alumnos/'.$peri_codi.'/'.$alum_codi.'.jpg';
if (file_exists($file_exi))
{	$pp=$file_exi;
} 
else 
{	$pp='../../../../fotos/ecobab/alumnos/0.jpg';
}
$pdf->setFoto($pp);
...
$logo_cole = '../../../../imagenes/clientes/ecobab/logo_inicial_long.png';
