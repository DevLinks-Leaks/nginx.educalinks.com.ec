...
<link href="../../theme/css/print.css" media="print" rel="stylesheet" type="text/css">
	...
	<body class="general admin"> 
								<!-- InstanceBeginEditable name="EditRegion3" --><?php  $Menu=607;    ?><!-- InstanceEndEditable -->
    ...
    <div class="options" style="width:75%; float:none;">
        <ul>
            <li>
            	<a class="button_text">
                	<select
										onchange="CargarPeriodosDistribucion(this.value);CargarCursosParalelos(this.value);CargarCursosParalelosMaterias(0);"
										style="width: 200px">
										<?
...
<div class="alumnos_main_lista" style="float:none; width:100%;">
    <table class="table_striped" id="alum_table">
     ...
     <tbody>
     <tr>
        <td><h3>Acta de calificaciones por materia-parcial</h3></td>
        <td>
            <a href="JavaScript:getURLActaMateriaParcialExcel();" >
            <img src="../imagenes/report_to_excel.png" style="width:45px;" border="0">
            </a>
        </td>
     </tr>
     </tbody>
