...
{	private $codigo;
	...
	{	$logo_cole = $_SESSION['ruta_foto_logo_libreta'];
		...
		$this->MultiCell(0, 0, 'JORNADA: '.mb_strtoupper($this->jornada), 0, 'L', 0, 1, 220, 10, true);
		$this->SetFont('helvetica', '', 8);
		$this->MultiCell(0, 0, mb_strtoupper(substr($this->nombre.' '.$this->apellido,0,45),'utf8'), 0, 'L', 0, 1, 220, 17, true);
		$this->MultiCell(0, 0, $this->codigo, 0, 'L', 0, 1, 220, 22, true);
	}
...
$tabla_cuantitativa.='<tr><td class="cuerpo_notas" colspan="3"> * Calificación menor al mínimo requerido.</td></tr>';
...
<tr>
<td> {$tabla_proyecto}</td>
</tr>
<tr>
<td> {$tabla_inasistencias}</td>
</tr>
<tr>
<td>{$tabla_observaciones}</td>
</tr>
</table>
<br/><br/>
<table width="99%">
