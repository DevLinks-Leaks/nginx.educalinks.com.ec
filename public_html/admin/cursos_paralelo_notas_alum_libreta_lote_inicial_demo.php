...
<div class="libreta" style="clear:both;">
      ...
      <table class="table_striped" width="50%">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td align="center">
				<?=
                 ($row_alum_nota_peri_dist_view[$CC_COLUM_index + 11]==0 or $row_alum_nota_peri_dist_view["es_padre"])?
                 '':nota_peri_cual_cons($_SESSION['peri_codi'], 
				 						$row_alum_nota_peri_dist_view['nota_refe_cab_codi'], 
										$row_alum_nota_peri_dist_view[$CC_COLUM_index + 11]); 
                ?>
          </td>
  ...
  <table class="table_striped">
	...
	$row_curs_info['curs_orden']==13)
	{
		...
		$nota_peri_cual_tipo_view = sqlsrv_query($conn, $sql, $params);
	?>
  <table class="table_striped" style="margin-top: 1px; border: solid 1px red">
        <thead>
        <tr>
		...
		?>
		<div style="border: 1px solid #999; height: 100px; margin-top: 1px;">
