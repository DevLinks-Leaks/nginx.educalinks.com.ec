        ...
        <?php 
			...
			while ($row_curs_para_mate_prof_view = sqlsrv_fetch_array($curs_para_mate_prof_view))
			{
				...
				echo '<a 
						...
						onclick="alum_curs_para_mate_upd('.$row_curs_peri_mate_view["curs_para_mate_codi"].','.$row_curs_para_mate_prof_view["curs_para_mate_prof_codi"].','.$row_curs_para_mate_prof_view["aula_codi"].',
                ...
                <ul>
                    ...
                    <li>
                    	<a 
                            ...
                            onclick="curs_para_mate_mode_upd(<?php echo $row_curs_peri_mate_view["curs_para_mate_codi"]; ?>, <?php echo $row_curs_peri_mate_view["nota_refe_cab_cod"]; ?>, <?php echo $row_curs_peri_mate_view["peri_dist_cab_codi"]; ?>)"
