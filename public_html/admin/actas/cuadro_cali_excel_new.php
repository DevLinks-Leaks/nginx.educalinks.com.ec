<?php
	...
	{   //Columnas y filas
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(0, 1, mb_strtoupper(para_sist(36).' '.para_sist(3),'utf8'));
		...
		$objPHPExcel->getActiveSheet()->getStyle(PHPExcel_Cell::stringFromColumnIndex(1).($i+8))->applyFromArray($styleArrayFont);
		$i++;
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(1, ($i+8), PrimeraMayuscula(show_this(10000001)) . ': ' . $_SESSION['usua_codi']);
		$objPHPExcel->getActiveSheet()->getStyle(PHPExcel_Cell::stringFromColumnIndex(1).($i+8))->getFont(1)->setBold(true);
		$objPHPExcel->getActiveSheet()->getStyle(PHPExcel_Cell::stringFromColumnIndex(1).($i+8))->applyFromArray($styleArrayFont);
