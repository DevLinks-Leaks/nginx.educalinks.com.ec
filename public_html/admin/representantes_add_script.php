...
<div class="picture">
    <div class="buttons">
        ...
        <ul>
            <li>
            <? if ($repr_codi==0){?>
                <button id="btn_guardar" name="btn_guardar" type="button" onClick="load_ajax_add_repr('div_repr_list','script_repr.php','opc=repr_add&repr_nomb='+document.getElementById('repr_nomb').value+'&repr_apel='+document.getElementById('repr_apel').value+'&repr_cedula='+document.getElementById('repr_cedula').value+'&repr_tipo_iden='+document.getElementById('repr_tipo_iden').options[document.getElementById('repr_tipo_iden').selectedIndex].value+'&repr_email='+document.getElementById('repr_email').value+'&repr_telf='+document.getElementById('repr_telf').value+'&repr_domi='+document.getElementById('repr_domi').value+'&repr_estado_civil='+document.getElementById('repr_estado_civil').value+'&repr_celular='+document.getElementById('repr_celular').value+'&alum_codi='+document.getElementById('alum_codi').value+'&repr_profesion='+document.getElementById('repr_profesion').value+'&repr_nacionalidad='+document.getElementById('repr_nacionalidad').value+'&repr_lugar_trabajo='+document.getElementById('repr_lugar_trabajo').value+'&repr_direc_trabajo='+document.getElementById('repr_direc_trabajo').value+'&repr_cargo='+document.getElementById('repr_cargo').value+'&repr_religion='+document.getElementById('repr_religion').value+'&repr_estudios='+document.getElementById('repr_estudios').value+'&repr_institucion='+document.getElementById('repr_institucion').value+'&repr_motivo_representa='+document.getElementById('repr_motivo_representa').value+'&repr_escolaborador='+document.getElementById('repr_escolaborador').checked+'&repr_ex_alum='+document.getElementById('repr_ex_alum').checked+'&repr_fech_promoc='+document.getElementById('repr_fech_promoc').value+'&repr_telf_trab='+document.getElementById('repr_telf_trab').value);">Guardar</button>
            <? }else{?>
                <button id="btn_guardar" name="btn_guardar" type="button" onClick="load_ajax_upd_repr('div_repr_list','script_repr.php','opc=repr_upd&repr_nomb='+document.getElementById('repr_nomb').value+'&repr_apel='+document.getElementById('repr_apel').value+'&repr_cedula='+document.getElementById('repr_cedula').value+'&repr_tipo_iden='+document.getElementById('repr_tipo_iden').options[document.getElementById('repr_tipo_iden').selectedIndex].value+'&repr_email='+document.getElementById('repr_email').value+'&repr_telf='+document.getElementById('repr_telf').value+'&repr_domi='+document.getElementById('repr_domi').value+'&repr_estado_civil='+document.getElementById('repr_estado_civil').value+'&repr_celular='+document.getElementById('repr_celular').value+'&repr_codi=<?= $repr_codi?>'+'&repr_profesion='+document.getElementById('repr_profesion').value+'&repr_nacionalidad='+document.getElementById('repr_nacionalidad').value+'&repr_lugar_trabajo='+document.getElementById('repr_lugar_trabajo').value+'&repr_direc_trabajo='+document.getElementById('repr_direc_trabajo').value+'&repr_cargo='+document.getElementById('repr_cargo').value+'&repr_religion='+document.getElementById('repr_religion').value+'&repr_estudios='+document.getElementById('repr_estudios').value+'&repr_institucion='+document.getElementById('repr_institucion').value+'&repr_motivo_representa='+document.getElementById('repr_motivo_representa').value+'&repr_escolaborador='+document.getElementById('repr_escolaborador').checked+'&repr_ex_alum='+document.getElementById('repr_ex_alum').checked+'&repr_fech_promoc='+document.getElementById('repr_fech_promoc').value+'&repr_telf_trab='+document.getElementById('repr_telf_trab').value);">Grabar cambios</button>
            <? }?>
            </li>
            <li>
