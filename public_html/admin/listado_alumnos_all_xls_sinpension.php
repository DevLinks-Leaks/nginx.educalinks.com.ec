<?php
	...
	$objPHPExcel->getActiveSheet()->getStyle("A1:AX1")->applyFromArray($style_cabecera);
	$objPHPExcel->getActiveSheet()->getRowDimension(1)->setRowHeight(40);
	$objPHPExcel->getActiveSheet()->getStyle("A2:AX2")->applyFromArray($style_cabecera);
	...
	$objPHPExcel->setActiveSheetIndex(0)->mergeCells('AQ1:AX1');
	...
	{	$objPHPExcel->getActiveSheet()->getStyle("A".($cc+2).":AX".($cc+2))->applyFromArray($style_detalle);
		/*Datos del estudiante*/
