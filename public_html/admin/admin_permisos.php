...
<?php include ('head.php');?>
	...
	<body class="general admin"> 
								<!-- InstanceBeginEditable name="EditRegion3" --><?php  $Menu=406;    ?><!-- InstanceEndEditable -->
		<div class="pageContainer"> 
          ...
          <div class="title"><h3><span class="icon-lock icon">
            </span>Permisos</h3>
          </div>
          <div class="options">
            <ul>
              <li class="button_text">
