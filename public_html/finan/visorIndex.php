...
<link href="<?= $ruta_includes_visor;?>/bootstrap/css/bootstrap.css" rel="stylesheet">
<link href="<?= $ruta_includes_visor;?>/bootstrap/css/theme.css" rel="stylesheet">
<link href="<?= $ruta_includes_visor;?>/bootstrap/css/bootstrap-theme.css" rel="stylesheet">
<link href="<?= $ruta_includes_visor;?>/jquery/jquery-ui/jquery-ui.css" rel="stylesheet">
<link rel="shortcut icon" href="site_media/imagenes/favicon.png" />
<link rel="stylesheet" type="text/css" media="screen" href="<?= $ruta_includes_visor;?>/bootstrap/css/datatable-bootstrap.css">
<script src="<?= $ruta_includes_visor;?>/jquery/jquery-2.1.1.js"></script>
<script src="<?= $ruta_includes_visor;?>/bootstrap/js/bootstrap.js"></script>
<script src="<?= $ruta_includes_visor;?>/jquery/jquery-ui/jquery-ui.js"></script>

</head>
<body>
	<div class="container">
	  <h1 style="display:block-inline; width:500px; margin: 0px auto; text-align:center;">Visor de facturas autorizadas</h1>
      <form class="form-signin" action="<?= $ruta_main;?>finan/documentosAutorizados/" method="post" enctype="multipart/form-data">
