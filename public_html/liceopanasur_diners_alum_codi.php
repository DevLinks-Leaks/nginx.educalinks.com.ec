...
<html>
    ...
    <form id="frm_diners" action="" method="post" enctype="multipart/form-data">
        ...
        <?php
		$_SESSION['host']='69.64.91.237';
		$_SESSION['db']='Educalinks_liceopanamericano_sur';
	 ...
	 WHERE a.alum_estado='A'
	   ...
	   and cf.cabefact_estado='PC' --FACTURA PAGADA";
		...
		while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
			...
			if($valor>0)
			{	echo "<br />";
			    echo $row['alum_codi']."&nbsp;&nbsp;&nbsp;"."200".str_pad($row['alum_resp_form_banc_tarj_nume'],14,'0',STR_PAD_LEFT)."14".str_pad(date('m'),2,'0',STR_PAD_LEFT).str_pad(date('d'),2,'0',STR_PAD_LEFT).str_pad($ult_reg,7,'0',STR_PAD_LEFT)."00"."000000".str_pad($valor,13,'0',STR_PAD_LEFT)."0000000000000".str_pad($valor,13,'0',STR_PAD_LEFT)."001"."0000000000000"."0"."00"."000"."0"."0"."000000000000000000000000000000"."00000000000000".str_pad($valor,14,'0',STR_PAD_LEFT)."00000000000000";
			}
		}
