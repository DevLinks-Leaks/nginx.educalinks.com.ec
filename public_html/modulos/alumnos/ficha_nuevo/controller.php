...
function handler() {
    ...
    switch ($event) {
		...
		case GET_FICHA_MED_LISTADO:
			...
			{	$opciones['PDF'] = 	" <span onclick='js_ficha_med_formulario_pdf(\"div_ficha_med_modal_pdf\", \"fmex\", \"{codigo}\" )' ".
										" 	class='btn_opc_lista_eliminar fa fa-file-pdf-o cursorlink' aria-hidden='true' id='{codigo}_editar' ".
											" onmouseover='$(this).tooltip(\"show\")' title='Ver ficha en PDF' data-placement='left'></span>&nbsp;";
