...
function handler()
{
	...
	{	case VIEW_ASIGN :
			...
			$construct_table=
			"<br>
			 <table class='table table-striped table-bordered' id='tabla_asigna_repr' width='100%'>
				<thead>
					<tr>       
			...
			{	if($c<($aux-1))
				{	$body.="<tr>";
					...
					$radioFina="<input type='radio' name='financiero' onclick='js_representantes_repr_upd_princ_finan(\"div_repr_list\",".'"'.$diccionario['rutas_head']['ruta_html_common'].'/representantes/controller.php"'.",\"".$alum_codi."\",\"".$repr_codi."\");' ".
			...
			{    $representante->get_representante_new($user_data['alum_codi']);
				...
				{	if($c<($aux-1))
					{	$body.="<tr>";
						...
						$radioMain="<input type='radio' name='principal' onclick='js_representantes_set_repr_acad(\"div_repr_list\",".'"'.$diccionario['rutas_head']['ruta_html_common'].'/representantes/controller.php"'.",\"".$alum_codi."\",\"".$repr_codi."\",\"".$relacion."\");' ".
						...
						$radioFina="<input type='radio' name='financiero' onclick='js_representantes_set_repr_finan(\"div_repr_list\",".'"'.$diccionario['rutas_head']['ruta_html_common'].'/representantes/controller.php"'.",\"".$alum_codi."\",\"".$repr_codi."\",\"".$relacion."\");' ".
						...
						$radioFina.="/>";
						$botonEditar = "<span onclick='js_enviarSolicitud_editar_datos_admision(\"".$alum_codi."\",\"".$repr_codi."\",".'"modal_add_repr_body"'.",".'"'.$diccionario['rutas_head']['ruta_html_admisiones'].'/enviarSolicitud/controller.php"'.")' 
