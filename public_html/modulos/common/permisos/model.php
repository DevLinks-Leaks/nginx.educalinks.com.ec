...
class PtoEmision extends DBAbstractModel{
    ...
    public function set ($data=array()){
        if (array_key_exists('puntVent_prefijo',$data) && array_key_exists('puntVent_codigoSucursal',$data) && array_key_exists('puntVent_secuencia',$data)){
            ...
            $this->parametros = array($puntVent_prefijo,$puntVent_codigoSucursal,$puntVent_secuencia,$puntVent_estado);
    ...
    public function edit($data=array()) {
        ...
        $this->parametros = array($puntVent_codigo,$puntVent_prefijo,$puntVent_codigoSucursal,$puntVent_secuencia,$puntVent_estado);
        $this->sp = "str_consultaPtoVenta_upd";
        $this->executeSPAccion();
        if($this->filasAfectadas>0){
            $this->mensaje="Punto de Emisión modificado exitosamente";
        }else{
            $this->mensaje="No se ha actualizado el Punto de Emisión";
        }
    }
    /*
    ...
    public function delete($codigo='') {
        ...
        $this->executeSPAccion();
        if($this->filasAfectadas>0){
            $this->mensaje="Punto de Emisión eliminado exitosamente";
        }else{
            $this->mensaje="No se ha eliminado el Punto de Emisión";
        }
    }
