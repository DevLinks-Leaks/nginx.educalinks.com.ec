	...
	{   case GET_PAIS:
			...
			$data['{'.$user_data['combo_nombre_pais'].'}'] = array ("elemento"  => 	"combo", 
																	...
																	"options"   => 	array(	"name"		=>$user_data['combo_nombre_pais'],
																							...
																							"required"	=>"required",
																							"class"		=>"form-control",
																							"onChange"	=> "js_region_cargaCiudadDistrito('".$user_data['div_ciudad']."','".$user_data['div_ciudaddistrito']."','".$user_data['combo_nombre_ciudad']."','".$user_data['combo_nombre_ciudaddistrito']."','".$user_data['combo_nombre_pais']."', '".$diccionario['rutas_head']['ruta_html_common']."/region/controller.php')"),
																	"selected"  => 	0);
		...
		case GET_CIUDADDISTRITO:
			...
			{   $data['{'.$user_data['combo_nombre_ciudaddistrito'].'}'] = array (  "elemento"  => 	"combo", 
																					...
																					"options"   => 	array(	"name"		=>$user_data['combo_nombre_ciudaddistrito'],
																											...
																											"required"	=>"required",
																											"class"		=>"form-control",
																											"onChange"	=> "js_region_cargaCiudad('".$user_data['div_ciudad']."','".$user_data['combo_nombre_ciudad']."','".$user_data['combo_nombre_ciudaddistrito']."','".$user_data['combo_nombre_pais']."','".$diccionario['rutas_head']['ruta_html_common']."/region/controller.php')"),
																					"selected"  => 	0);
			}
			else
