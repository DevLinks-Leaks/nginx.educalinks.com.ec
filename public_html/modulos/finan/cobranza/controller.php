...
{   require('/../../../core/rutas.php');
	...
	{   case LOAD_DETA_DEUD:
        ...
        case GET:
            ...
            $data=array("combo" => $select='<select  id="tipo_iden" name="tipo_iden" class="form-control" disabled="disabled">
						...
						"combo_acad" => $select='<select  id="tipo_iden_acad" name="tipo_iden_acad" class="form-control" disabled="disabled">
