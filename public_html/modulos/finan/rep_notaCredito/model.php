...
class Rep_notaCredito extends DBAbstractModel{
    #propiedades
    public $banc_nombre;
    ...
    { 
        ...
        $this->executeSPConsulta();
         ...
         if (count($this->rows)<=0){
            ...
            foreach($this->rows as $cajeros){
                array_push($rol, array_values($cajeros));
            }
	...
	public function get_reporte_notaCredito($usuario='%', $alum_codi='%', $fecha_ini='%', $fecha_fin='%'){
        ...
        $this->sp = "str_consultarpt_notaCredito";
        $this->executeSPConsulta();
