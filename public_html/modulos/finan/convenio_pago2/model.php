...
class convenioPago extends DBAbstractModel{
    #propiedades
    public $numero;
    public $codigo;
	...
	public function set_convenioPago_pago( $codigoDocumento )
	{   $this->parametros = array( $codigoDocumento, $_SESSION['usua_codi'], $_SESSION['USUA_TIPO_CODI'], $_SESSION['puntVent_codigo'], $_SESSION['caja_codi'] );
        $this->sp = "str_ingresaPago_convenio";
        $this->executeSPConsulta();

        if (count($this->rows)>1)
		{   $this->mensaje="¡Exito! Pago realizado.";
			$this->estado="PAGADO";
        }else
		{   $this->mensaje="¡Error! No se pudo completar el requerimiento.";
			$this->estado="ERROR";
        }
	}
