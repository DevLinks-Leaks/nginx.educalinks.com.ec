	<aside class="main-sidebar">
        ...
        <section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="<? if ($Menu==2) echo 'active'; ?>"><a href="agenda.php"><i class="fa fa-home"> </i> <span>Agenda</span></li></a>
				<li class="<? if ($Menu==3) echo 'active'; ?>"><a href="clases.php"><i class="fa fa-book"> </i> <span>Clases</span></li></a>
