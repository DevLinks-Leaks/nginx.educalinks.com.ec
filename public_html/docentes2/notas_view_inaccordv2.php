		...
		<tr>
			...
			<td style='text-align:center;'>
				<div class="btn-group-vertical">
					<?if ($row_curs_peri_view['nota_peri_esta_resu']=='A') {?>
					  <a onclick="form_notas_send(<?=$row_curs_peri_view['curs_para_mate_prof_codi'];?>,<?=$row_curs_peri_view['curs_para_mate_codi'];?>,<?=$row_curs_peri_view['peri_dist_codi'];?>,<?=$row_curs_peri_view['nota_perm_codi']?>,'in')" class="btn btn-default"> 
