// JavaScript Document
function js_elemento_protex_cargaTipo( div_resultado, combo_nombre, tipo_codi )
{   "use strict";
    ...
    xhr.open('POST', document.getElementById('ruta_html_common').value + '/elemento_protex/controller.php' , true);
...
function js_elemento_protex_cargaTipo_SelectFormat( div_resultado, combo_nombre, div_followed, combo_nombre_followed )
{   "use strict";
    document.getElementById( div_resultado ).innerHTML='<br><div align="center" style="height:100%;"><i style="font-size:large;color:darkred;" class="fa fa-cog fa-spin"></i></div>';
	var data = new FormData();
    data.append( 'combo_nombre', combo_nombre );
...
function js_elemento_protex_cargaElemento( div_resultado, combo_nombre, tipo_codi, ele_protex_codi )
{   "use strict";
    document.getElementById( div_resultado ).innerHTML='<br><div align="center" style="height:100%;"><i style="font-size:large;color:darkred;" class="fa fa-cog fa-spin"></i></div>';
	var data = new FormData();
...
function js_elemento_protex_cargaElemento_SelectFormat( div_resultado, combo_nombre, tipo_codi )
{   "use strict";
    document.getElementById( div_resultado ).innerHTML='<br><div align="center" style="height:100%;"><i style="font-size:large;color:darkred;" class="fa fa-cog fa-spin"></i></div>';
	var data = new FormData();
    data.append( 'tipo_codi', tipo_codi );
