...
{   "use strict";
    if( document.getElementById( combo_nombre_pais ) )
		...
		var paisCodigo = "-1";
    document.getElementById(div_pais).innerHTML='<br><div align="center" style="height:100%;"><i style="font-size:large;color:darkred;" class="fa fa-cog fa-spin"></i></div>';
...
{   "use strict";
	...
	document.getElementById(div_ciudaddistrito).innerHTML='<br><div align="center" style="height:100%;"><i style="font-size:large;color:darkred;" class="fa fa-cog fa-spin"></i></div>';
    var data = new FormData();
    data.append( 'paisCodigo', paisCodigo );
...
{   "use strict";
	...
	/*if( document.getElementById( combo_nombre_ciudad ) )
		...
		var ciudadID = "-1";
	document.getElementById(div_ciudad).innerHTML='<br><div align="center" style="height:100%;"><i style="font-size:large;color:darkred;" class="fa fa-cog fa-spin"></i></div>';
    var data = new FormData();
    data.append( 'paisCodigo', paisCodigo );
    data.append( 'ciudadDistritoCodigo', ciudadDistritoCodigo );
