		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-success" id='btn_docuAdmin_edi' name='btn_docuAdmin_edi'
						onClick="js_docAdmin_event('div_documentos_tabla','{ruta_html_admisiones}/documentos_admision/controller.php', 'edit', 
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-success" id='btn_docuAdmin_add' name='btn_docuAdmin_add'
					onclick="js_docAdmin_event('div_documentos_tabla','{ruta_html_admisiones}/documentos_admision/controller.php', 'set', 
	...
	<div class='row'>
		<div class='col-sm-2'> 
			...
			<button class='btn btn-primary' id='btn_selectTipoDocAut' name='btn_selectTipoDocAut' 
					onclick="js_docAdmin_get_all('div_documentos_tabla','{ruta_html_admisiones}/documentos_admision/controller.php')"><li class='fa fa-search'></li>&nbsp;
			</button>
		</div>
