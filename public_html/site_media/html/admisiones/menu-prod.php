	<aside class="main-sidebar">
        ...
        <section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="{open0}"><a href="../general/"><i class="fa fa-home"> </i> <span>Inicio</span></a></li><!-- {menu001} -->
				<li class="{open1} treeview">
					...
					<ul class="treeview-menu">
						...
						<li class="{menu104}">{NotadeDebito}</li>
						...
						<li role="presentation" class="{menu110}">{ConvenioMandato}</li>
				...
				<li><a href="../general/"><i class="fa fa-question-circle"></i> <span>Ayuda</span></a><li><!-- {menu001} -->
				<li class="{open7}"><a href="../acerca/"><i class="icon icon-logo"></i> <span>Acerca de Educalinks</span></a></li><!-- {menu001} -->
			</ul>
        </section>
        <!-- /.sidebar -->
    </aside>