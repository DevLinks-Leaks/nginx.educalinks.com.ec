...
<div class="grid">
	...
	<div class="row">
		<div class="col-sm-3">
			...
			<input name="{repr}_fecha_nac" id="{repr}_fecha_nac"  type="date" class="form-control" value="{repr_fecha_nac}" placeholder="Fec. Nacimiento"/>
		</div>
		<div class="col-sm-3">
			<label>Pais</label>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="input-group" id="div_{repr}_es_extrabajador" name="div_{repr}_es_extrabajador" >
				...
				<input type="date" class="form-control" name="{repr}_es_extrabajador_fecha_ini" id="{repr}_es_extrabajador_fecha_ini" 
				...
				<input type="date" class="form-control" name="{repr}_es_extrabajador_fecha_fin" id="{repr}_es_extrabajador_fecha_fin" 
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<button type="button" class="btn btn-success" 
				onclick="js_enviarSolicitud_guarda_formulario_repr('{ruta_html_admisiones}/enviarSolicitud/controller.php');$('#modal_add_repr').modal('hide');">
