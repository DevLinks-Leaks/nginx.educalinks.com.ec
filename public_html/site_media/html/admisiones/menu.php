	<aside class="main-sidebar">
        ...
        <section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li><a href="../../admisiones/enviarSolicitud/" title="Ingreso de solicitud nueva e inicio del proceso de solicitud"><i class="fa fa-child"></i> <span>Ingresar solicitud</span></a></li>
				<li class="{openSoli} treeview">
					...
					<ul class="treeview-menu">
						<li class="{menuSoli01}"><a href="../../admisiones/verSolicitud/"><i class="fa fa-send"></i>Recibidas</a></li>
						...
						<li class="{menuSoli08}"><a href="#" onclick="js_verSolicitud_guardada();"><i class="fa fa-floppy-o"></i>Guardadas</a></li>
						<!--<li class="{menuSoli09}"><a href="#" onclick="js_verSolicitud_no_admitido();"><i class="fa fa-ban"></i>No admitidos</a></li>-->
						<li class="{menuSoli10}"><a href="#" onclick="js_verSolicitud_mantenimiento();"><i class="fa fa-inbox"></i>Administrar todas</a></li>
					</ul>
				</li>
				...
				<li class="{openSoliConfigSist} treeview">
					...
					<ul class="treeview-menu">
						...
						<li class="{menuopenSoliConfigSist02}"><a href="../../admisiones/documentos_admision/"><i class="fa fa-paperclip"></i>Documentos adjuntos</a></li>
					</ul>
				</li>
