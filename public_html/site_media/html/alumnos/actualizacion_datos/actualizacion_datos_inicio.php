...
<div>
	<button class="btn btn-success" type="button" onclick="js_actualizacion_datos_formulario_set('{per}');" >Guardar y volver</button>
</div>
<div>
	<br>
</div>
		...
		<div class="grid">
			<div class="row">
				<div class="col-sm-12"  style='text-align:center;'>
					<input type="radio" id="{per}_rdb_tipo_ficha" name="{per}_rdb_tipo_ficha" value="UPD" checked> Actualización
				</div>
			</div>
		</div>
	</div>
...
<div class="nav-tabs-custom">
	<ul class="nav nav-tabs">
		...
		<li style="display:none"><a href="#tab_2" data-toggle="tab"><i class="fa fa-child"></i> Examen Físico</a></li>
		...
		<li style="display:none"><a href="#tab_6" data-toggle="tab"><i class="fa fa-eye"></i> Estado mental</a></li>
		<li style="display:none"><a href="#tab_8" data-toggle="tab"><i class="fa fa-unlink"></i> Cirugías</a></li>
		<li style="display:none"><a href="#tab_9" data-toggle="tab"><i class="fa fa-sticky-note-o"></i> Radiografía/Ex. clínicos</a></li>
	</ul>
		...
		<div class="tab-pane active" id="tab_1">
			<div class="grid">
				<div class="row" style='display:none;'>
					...
					<div class="col-sm-11">
						<input type="radio" id="{per}_rdb_tabaco" name="{per}_rdb_tabaco" value="S" > Si
						<input type="radio" id="{per}_rdb_tabaco" name="{per}_rdb_tabaco" value="N" checked> No
					</div>
				</div>
				<div class="row" style='display:none;'>
					<div class="col-sm-1">
					...
					<div class="col-sm-11">
						<input type="radio" id="{per}_rdb_alcohol" name="{per}_rdb_alcohol" value="S" > Si
						<input type="radio" id="{per}_rdb_alcohol" name="{per}_rdb_alcohol" value="N" checked> No
					</div>
				</div>
				<div class="row" style='display:none;'>
					<div class="col-sm-1">
					...
					<div class="col-sm-11">
						<input type="radio" id="{per}_rdb_drogas" name="{per}_rdb_drogas" value="S" > Si
						<input type="radio" id="{per}_rdb_drogas" name="{per}_rdb_drogas" value="N" checked> No
					</div>
				</div>
				<div class="row">
								...
								<table style='width:100%'>
									<tr>
										...
										<td style='text-align:right;'>
											<button type="button" class="btn btn-info" onclick="js_ficha_add_alergia('div_tbl_alergia', '{per}', '' );">
							...
							<div class='panel-heading'>
								<table style='width:100%'>
									<tr>
										...
										<td style='text-align:right;'>
											<button type="button" class="btn btn-info" onclick="js_ficha_add_vacuna('div_tbl_vacuna', '{per}', '' );">
									...
									<div class="form-group">
										<div class="col-sm-6">
											...
											<input name="{per}_corazon" id="{per}_corazon"  type="text" class="form-control" value="{per_corazon}"
												pattern = "^([A-Za-zÑñáéíóúÁÉÍÓÚ ]+)$" maxlength="60" placeholder="(Describir alguna enfermedad si es que la tiene)"/>
										</div>
									...
									<div class="form-group">
										<div class="col-sm-6">
											...
											<input name="{per}_superior_derecha" id="{per}_superior_derecha"  type="text" class="form-control" value="{per_superior_derecha}"
												pattern = "^([A-Za-zÑñáéíóúÁÉÍÓÚ ]+)$" maxlength="60" placeholder="(ALTO, MEDIO O BAJO)"/>
										</div>
										<div class="col-sm-6">
			...
			<div class="form-horizontal">
				<div class="form-group">
					<div class="col-sm-6">
						...
						<input type="radio" id="{per}_rdb_reflex_tendinosos" name="{per}_rdb_reflex_tendinosos" value="A" {per_reflex_tendinoso_a}> Sin reflejo
						<input type="radio" id="{per}_rdb_reflex_tendinosos" name="{per}_rdb_reflex_tendinosos" value="HIPO" {per_reflex_tendinoso_hipo}> Baja
						...
						<input type="radio" id="{per}_rdb_reflex_tendinosos" name="{per}_rdb_reflex_tendinosos" value="HIPER" {per_reflex_tendinoso_hiper}> Alta
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-6">
						<label><span class='fa fa-eye-slash'></span>&nbsp;Reflejos pupilares</label>
						<input type="radio" id="{per}_rdb_reflex_pupilares" name="{per}_rdb_reflex_pupilares" value="A" {per_reflex_pupilares_a}> Sin reflejo
						<input type="radio" id="{per}_rdb_reflex_pupilares" name="{per}_rdb_reflex_pupilares" value="HIPO" {per_reflex_pupilares_hipo}> Baja
						...
						<input type="radio" id="{per}_rdb_reflex_pupilares" name="{per}_rdb_reflex_pupilares" value="HIPER" {per_reflex_pupilares_hiper}> Alta
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-6">
					...
					<div class="col-sm-6">
						<label>Tacto (Sensibilidad superficial)</label>
