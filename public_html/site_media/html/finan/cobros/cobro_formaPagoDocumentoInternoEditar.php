<div id="frm_actualizacionFormaPagoDocumentoInterno" class="form-medium">
    ...
    <div class="form-group">
        ...
        <div class="input-group"
            ...
            <input type="text" class="form-control" name="monto" id="monto" value="{doc_int_monto}"
				onkeypress="return spacebar_retorna_cero(event,this);" onkeyup="return enterpress_editpay(event)" 
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="detalle" id="detalle"
				...
				onfocus='$(this).tooltip("show")'
				onmouseover='$(this).tooltip("show")'
			onkeypress="return permite(event, 'num_car')" maxlength="50"  value="{doc_int_detalle}" placeholder="Descripci&oacute;n del documento"
			required='required'>
		<span class="help-block with-errors"></span>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="observacion" id="observacion" 
			onkeypress="return permite(event, 'num_car')" maxlength="50" value="{doc_int_observacion}" placeholder="Observaciones"
			>
		<span class="help-block with-errors"></span>
    </div>
</div>