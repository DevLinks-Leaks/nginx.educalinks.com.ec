...
<html lang="es">
	<head>
		...
		<style type="text/css">
			...
			#detalleFactura td:last-child, #detalleFactura td:nth-child(4), #detalleFactura td:nth-child(5), #detalleFactura td:nth-child(6) {
				text-align: right;
			}
			#detalleFactura td:last-child:before, #detalleFactura td:nth-child(4):before, #detalleFactura td:nth-child(5):before, #detalleFactura td:nth-child(6):before {
				content: "$ ";
			}
			...
			<div id="datosFactura">
				<table border='0' style="width:100%" >
					<tbody>
						...
						<tr>
							<td colspan='2'>NOTA DE CRÉDITO</td>
						</tr>
						<tr>
							<td>No.</td>
		...
		<section id="datosCliente">
			<table border='0'>
				...
				<tr style="width:30%;">
					...
					<td>{fecha_emision}</td>
					<td class="nombreCampo">Doc. que modifica:</td>
					<td>{doc_modifica}</td>
				</tr>
			</table>
