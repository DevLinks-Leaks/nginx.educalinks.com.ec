	...
	<div class="modal-body">
			...
			<li role="presentation" class="active"><a href="#home" 
				onclick="editar('{codigo}','{codigoAlumno}','modal_edit_body','{ruta_html_finan}/gestionNotasdebito/controller.php','{ruta_html_common}/representantes/controller.php',true)"
		...
		<div class="tab-content">
			<div role="tabpanel" class="tab-pane active" id="home">
				<br>
				<form id='frm_pago' name='frm_pago' onsubmit="return validaSave_edited('{ruta_html_finan}/gestionNotasdebito/controller.php')" role="form" data-toggle="validator">
					<div class="row">
						<div class="form-group">
							...
							<div class="col-sm-6">
								<div class='alert alert-info fade in'>
									<small>
										<table width='100%'>
											<tr><td style='vertical-align:top' colspan='2'><b>Datos del titular en la Nota de D&eacute;bito</b></td></tr>
					...
					<div class="row" >
						<div class="form-group">
							<div class="col-sm-12">
							<table width='100%'>
								<tr><td style='vertical-align:top'><input type="checkbox" class="checkbox" name="ckb_datosPersonales" id="ckb_datosPersonales" checked='checked'> </td>
