...
<div class='panel panel-primary'>
	<div class='panel-heading' style='text-align:center;'>
		FICHA MÉDICA {per_paciente_nombre}
	</div>
		...
		<div class="grid">
			<div class="row">
				<div class="col-sm-12"  style='text-align:left;'>
					<a class='button_medic_menu btn btn-primary btn-block' onclick='js_ficha_nuevo_navbar(this);' href="#tab_1" data-toggle="tab"><span style="font-size:xx-small;"><i class="fa fa-clipboard"></i> Antecedente personal</span></a>
					<a class='button_medic_menu btn btn-default btn-block' onclick='js_ficha_nuevo_navbar(this);' href="#tab_2" data-toggle="tab"><span style="font-size:xx-small;"><i class="fa fa-child"></i> Ex. Físico</span></a>
					<a class='button_medic_menu btn btn-default btn-block' onclick='js_ficha_nuevo_navbar(this);' href="#tab_3" data-toggle="tab"><span style="font-size:xx-small;"><i class="fa fa-bed"></i> Ex. Regional</span></a>
					<a class='button_medic_menu btn btn-default btn-block' onclick='js_ficha_nuevo_navbar(this);' href="#tab_4" data-toggle="tab"><span style="font-size:xx-small;"><i class="fa fa-assistive-listening-systems"></i> Órganos de sentidos</span></a>
					<a class='button_medic_menu btn btn-default btn-block' onclick='js_ficha_nuevo_navbar(this);' href="#tab_5" data-toggle="tab"><span style="font-size:xx-small;"><i class="fa fa-hand-lizard-o"></i> Ex. Neurológico</span></a>
					<a class='button_medic_menu btn btn-default btn-block' onclick='js_ficha_nuevo_navbar(this);' href="#tab_6" data-toggle="tab"><span style="font-size:xx-small;"><i class="fa fa-eye"></i> Estado mental</span></a>
					<a class='button_medic_menu btn btn-default btn-block' onclick='js_ficha_nuevo_navbar(this);' href="#tab_8" data-toggle="tab"><span style="font-size:xx-small;"><i class="fa fa-unlink"></i> Cirugías</span></a>
					<a class='button_medic_menu btn btn-default btn-block' onclick='js_ficha_nuevo_navbar(this);' href="#tab_9" data-toggle="tab"><span style="font-size:xx-small;"><i class="fa fa-sticky-note-o"></i> Ex. clínicos</span></a>
					<a class='button_medic_menu btn btn-default btn-block' onclick='js_ficha_nuevo_navbar(this);' href="#tab_7" data-toggle="tab"><span style="font-size:xx-small;"><i class="fa fa-comment-o"></i> Conclusiones</span></a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="nav-tabs-custom">
		<div class="tab-content">
			<div class="tab-pane active" id="tab_1">
				<div class='panel panel-primary'>
					<div class='panel-heading' style='text-align:center;'>
						<i class="fa fa-clipboard"></i>  Antecedente personal
					</div>
				</div>
				<div class="grid">
					<div class="row">
						<div class="col-sm-1">
							<label style='font-size:small;'>Tabaco</label>
						</div>
						<div class="col-sm-11">
					...
					<div class="row">
						<div class="col-sm-1">
							<label style='font-size:small;'>Alcohol</label>
						</div>
						<div class="col-sm-11">
					...
					<div class="row">
						<div class="col-sm-1">
							<label style='font-size:small;'>Drogas</label>
						</div>
						<div class="col-sm-11">
									...
									<table style='width:100%'>
										<tr>
											...
											<td style='text-align:right;'>
												<button type="button" class="btn btn-sm btn-danger" onclick="js_ficha_add_alergia('div_tbl_alergia', '{per}', '' );">
								...
								<div class='panel-heading'>
									<table style='width:100%'>
										<tr>
											...
											<td style='text-align:right;'>
												<button type="button" class="btn btn-sm btn-warning" onclick="js_ficha_add_vacuna('div_tbl_vacuna', '{per}', '' );">
								...
								<div class='panel-heading'>
									<table style='width:100%'>
										<tr>
											...
											<td style='text-align:right;'>
												<button type="button" class="btn btn-sm btn-info" onclick="js_ficha_add_enfermedad('div_tbl_enfermedad_familia', '{per}', '', 'F' );">
													<i class='fa fa-plus'></i>&nbsp;Agregar
												</button>
											</td>
										</tr>
								...
								<div class='panel-heading'>
									<table style='width:100%'>
										<tr>
											...
											<td style='text-align:right;'>
												<button type="button" class="btn btn-sm btn-info" onclick="js_ficha_add_enfermedad('div_tbl_enfermedad', '{per}', '', 'T' );">
													<i class='fa fa-plus'></i>&nbsp;Agregar
												</button>
											</td>
										</tr>
			...
			<div class="tab-pane" id="tab_2">
				<div class='panel panel-primary'>
					<div class='panel-heading' style='text-align:center;'>
						<i class="fa fa-child"></i>  Examen Físico
					</div>
				</div>
				<div class="grid">
					<div class="row">
						<div class="col-sm-4">
							<label style='font-size:small;'>Condición física</label>
						...
						<div class="col-sm-4">
							<label style='font-size:small;'>Actividad sicomotora</label>
							<input name="{per}_act_sicomotora" id="{per}_act_sicomotora"  type="text" class="form-control" value="{per_act_sicomotora}"
								pattern = "^([A-Za-zÑñáéíóúÁÉÍÓÚ ]+)$" maxlength="60"/>
						</div>
						<div class="col-sm-4">
							<label style='font-size:small;'>Deambulaci&oacute;n</label>
					...
					<div class="row">
						<div class="col-sm-4">
							<label style='font-size:small;'>Peso</label>
							<div class="input-group" style="width: 100%;">
						...
						<div class="col-sm-4">
							<label style='font-size:small;'>Temperatura Bucal</label>
							<div class="input-group" style="width: 100%;">
								<span style="width: 25%; font-size:small;" class="input-group-addon">
						...
						<div class="col-sm-4">
							<label style='font-size:small;'>Pulso</label>
							<div class="input-group" style="width: 100%;">
								<span style="width: 25%; font-size:small;" class="input-group-addon">
					...
					<div class="row">
						<div class="col-sm-4">
							<label style='font-size:small;'>Presi&oacute;n Arterial</label>
							<div class="input-group" style="width: 100%;">
								<span style="width: 25%; font-size:small;" class="input-group-addon">
			...
			<div class="tab-pane" id="tab_3">
				<div class='panel panel-primary'>
					<div class='panel-heading' style='text-align:center;'>
						<i class="fa fa-bed"></i> Examen Regional
					</div>
				</div>
				<div class="grid">
					<div class='row'>
								...
								<div class='panel-collapse collapse in'>
									<div class="form-horizontal">
										<div class="form-group">
											<div class="col-sm-6">
												<label style='font-size:small;'>Piel</label>
												<input name="{per}_piel" id="{per}_piel"  type="text" class="form-control" value="{per_piel}"
													pattern = "^([A-Za-zÑñáéíóúÁÉÍÓÚ ]+)$" maxlength="60"/>
											</div>
											<div class="col-sm-6">
												<label style='font-size:small;'>Ganglios</label>
							...
							<div class='panel panel-info'>
								...
								<div class='panel-collapse collapse in'>
									<div class="form-horizontal">
										<div class="form-group">
											<div class="col-sm-6">
												<label style='font-size:small;'>Coraz&oacute;n</label>
												<input name="{per}_corazon" id="{per}_corazon"  type="text" class="form-control" value="{per_corazon}"
													pattern = "^([A-Za-zÑñáéíóúÁÉÍÓÚ ]+)$" maxlength="60"/>
											</div>
											<div class="col-sm-6">
												<label style='font-size:small;'>Torax</label>
							...
							<div class='panel panel-info'>
								...
								<div class='panel-collapse collapse in'>
									<div class="form-horizontal">
										<div class="form-group">
											<div class="col-sm-6">
												<label style='font-size:small;'>H&iacute;gado</label>
												<input name="{per}_higado" id="{per}_higado"  type="text" class="form-control" value="{per_higado}"
													pattern = "^([A-Za-zÑñáéíóúÁÉÍÓÚ ]+)$" maxlength="60"/>
											</div>
											<div class="col-sm-6">
												<label style='font-size:small;'>Ves&iacute;cula Biliar</label>
										...
										<div class="form-group">
											<div class="col-sm-6">
												<label style='font-size:small;'>Bazo</label>
												<input name="{per}_bazo" id="{per}_bazo"  type="text" class="form-control" value="{per_bazo}" 
													pattern = "^([A-Za-zÑñáéíóúÁÉÍÓÚ ]+)$" maxlength="60"/>
											</div>
											<div class="col-sm-6">
												<label style='font-size:small;'>Est&oacute;mago</label>
										...
										<div class="form-group">
											<div class="col-sm-6">
												<label style='font-size:small;'>Ano</label>
									...
									<div class="form-horizontal">
										<div id='region_urgo_genital_masculina' name='region_urgo_genital_masculina' style="display:inline;">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<label style='font-size:small;'>Espermaquia</label>
										...
										<div id='region_urgo_genital_femenina' name='region_urgo_genital_femenina' style="display:inline;">
											<div class="form-group">
												<div class="col-sm-6">
													<label style='font-size:small;'>Tracto genital femenino</label>
												...
												<div class="col-sm-6">
													<label style='font-size:small;'>Menstruaci&oacute;n</label>
			...
			<div class="tab-pane" id="tab_4">
				<div class='panel panel-primary'>
					<div class='panel-heading' style='text-align:center;'>
						<i class="fa fa-assistive-listening-systems"></i> Órganos de sentidos
					</div>
				</div>
				<div class='grid'>
					<div class='row'>
			...
			<div class="tab-pane" id="tab_5">
				<div class='panel panel-primary'>
					<div class='panel-heading' style='text-align:center;'>
						<i class="fa fa-hand-lizard-o"></i> Examen Neurológico
					</div>
				</div>
				<div class="form-horizontal">
					<div class="form-group">
						<div class="col-sm-12">
							<label style='font-size:small;'><span class='fa fa-gavel'></span>&nbsp;Reflejos tendinosos</label>
					...
					<div class="form-group">
						<div class="col-sm-12">
							<label style='font-size:small;'><span class='fa fa-eye-slash'></span>&nbsp;Reflejos pupilares</label>
			...
			<div class="tab-pane" id="tab_6">
				<div class='panel panel-primary'>
					<div class='panel-heading' style='text-align:center;'>
						<i class="fa fa-eye"></i> Estado mental
					</div>
				</div>
				<div class="form-horizontal">
					<div class="form-group">
						<div class="col-sm-6">
							<label style='font-size:small;'>Estado mental</label>
							<div class="input-group" style="width: 100%;">
								<span style="width: 25%; font-size:small;" class="input-group-addon">
						...
						<div class="col-sm-6">
							<label style='font-size:small;'>Memoria</label>
							<div class="input-group" style="width: 100%;">
								<span style="width: 25%; font-size:small;" class="input-group-addon">
					...
					<div class="form-group">
						<div class="col-sm-6">
							<label style='font-size:small;'>Irritabilidad</label>
							<div class="input-group" style="width: 100%;">
								<span style="width: 25%; font-size:small;" class="input-group-addon">
						...
						<div class="col-sm-6">
							<label style='font-size:small;'>Depresi&oacute;n</label>
							<div class="input-group" style="width: 100%;">
								<span style="width: 25%; font-size:small;" class="input-group-addon">
			...
			<div class="tab-pane" id="tab_8">
				<div class='panel panel-primary'>
					<div class='panel-heading' style='text-align:center;'>
						<i class="fa fa-unlink"></i> Cirugías
					</div>
				</div>
				<div class="grid">
					<div class="row">
			...
			<div class="tab-pane" id="tab_9">
				<div class='panel panel-primary'>
					<div class='panel-heading' style='text-align:center;'>
						<i class="fa fa-sticky-note-o"></i> Radiografía/Ex. clínicos
					</div>
				</div>
				<div class="grid">
					<div class="row">
