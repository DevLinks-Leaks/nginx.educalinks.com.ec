		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" data-dismiss="modal" 
						onclick="js_persona_select_user_searchlist_followed(
									'{div_buttons}',
									'{div_show_result}',
									'{procedencia_formulario}', 
									document.getElementById('cmb_per_consulta_tipo_persona').value )"><span class='fa fa-hand-o-up'></span>&nbsp;Seleccionar</button>
			</div>
		</div>
	</div>
</div>
