...
<br>
<div id='div_opciones_principales' name='div_opciones_principales' class='grid' style='display:inline;'>
	<div class='row'>
...
<div id="div_continuar_solicitud" class="box box-default" style='display:none;'>
	...
	<div id="formulario_continuar_solicitud"class="box-body">
		<div class="callout callout-warning">
			...
			Ingrese el ID para continuar llenando su solicitud en el sistema. Ejemplos. --CAG2015001 (enviada) -------- (faltan requisitos) --CAG20160002(guardada)
		</div>
		<div class="grid">
			<div class="row">
				<div class="col-md-1">
