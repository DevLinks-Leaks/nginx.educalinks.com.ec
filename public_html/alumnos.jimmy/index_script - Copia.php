...
<div class="zones alumnos">
    <div class="zone" >        
        <?php
		echo $_SESSION['alum_codi'],$_SESSION['curs_para_codi'];
        ...
        while($row_curs_mate_view=sqlsrv_fetch_array($stmp_mate)){?>dd
            ...
            <div class="accordion-heading">
                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#mate_h<?= $row_curs_mate_view['curs_para_mate_codi'];?>" href="#mate_b_<?= $row_curs_mate_view['curs_para_mate_codi'];?>">
                        ...
                        <div class="title">  
                           ...
                           <?= strtoupper($row_curs_mate_view["mate_deta"]); ?>
                         </div>
                        ...
                        <div class="opciones">
                          ...
                          <?php 
                          $tipo_usua="A";
                          $params_agen = array($row_curs_mate_view['curs_para_mate_codi'],$tipo_usua);
