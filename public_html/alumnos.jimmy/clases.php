                              ...
                              <div style="width: 100%">
                                <button
                                    style="width: 100%; height: 50px"
                                      onClick="window.location='clases_main.php?curs_para_mate_codi=<?= $row_curs_mate_view['curs_para_mate_codi'];?>&curs_para_mate_prof_codi=<?= $row_curs_mate_view['curs_para_mate_prof_codi'];?>'"
                                    class="icons icon-search btn btn-primary">
                                    Ver Detalles del Curso
                                  </button>
                                <!--<a class="btn buttons" href="clases_main.php?curs_para_mate_codi=<?= $row_curs_mate_view['curs_para_mate_codi'];?>&curs_para_mate_prof_codi=<?= $row_curs_mate_view['curs_para_mate_prof_codi'];?>">
                            ...
                            <tbody>
                              <tr>
                                <td class="no-padding">
                                  <div class="post_list">
                                    <?php
                                    $params_post = array($row_curs_mate_view['curs_para_mate_codi']);
                              ...
                              <tr>
                                <td class="footer">
                                  <div class="details">
                                    <a class="btn btn-info" href="posts_main.php?curs_para_mate_codi=<?=$row_curs_mate_view['curs_para_mate_codi']?>">
